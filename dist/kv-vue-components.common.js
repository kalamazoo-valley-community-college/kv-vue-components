...
// CONCATENATED MODULE: ./src/components/kvButton.vue?vue&type=template&id=45c10606&
...
/* harmony default export */ var kvButtonvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    buttonColor: function buttonColor() {
      switch (this.color) {
        case 'red':
          return ['text-red-800', 'hover:text-white', 'focus:text-white', 'border border-gray-500', 'hover:border-red-800', 'focus:border-red-800'];

        case 'green':
          return ['text-green-800', 'hover:text-white', 'focus:text-white', 'border border-gray-500', 'hover:border-green-800', 'focus:border-green-800'];

        default:
          return ['text-blue-800', 'hover:text-white', 'focus:text-white', 'border border-gray-500', 'hover:border-blue-800', 'focus:border-blue-800'];
      }
    }
  }
});
