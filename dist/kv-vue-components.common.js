...
/* harmony default export */ var kvLabeledInputvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      input: null,
      classes: ['px-3', 'pb-2', 'pt-6', 'bg-white', 'border', 'border-gray-500', 'focus:border-blue-800', 'rounded', 'outline-none', 'focus:shadow-outline']
    };
  },
  methods: {
...
var kvLabeledInput_component = normalizeComponent(
  ...
  kvLabeledInputvue_type_template_id_96ee244c_render,
  kvLabeledInputvue_type_template_id_96ee244c_staticRenderFns,
  false,
  null,
  null,
  null
