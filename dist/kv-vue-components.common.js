...
/* harmony default export */ var kvLabeledInputvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      input: null,
      classes: ['appearance-none', 'px-3', 'pb-2', 'pt-6', 'bg-white', 'hover:bg-blue-100', 'shadow', 'rounded', 'focus:shadow-outline', 'outline-none', 'focus:shadow-outline', 'w-full']
    };
  },
  methods: {
...
var kvLabeledInput_component = normalizeComponent(
  ...
  kvLabeledInputvue_type_template_id_52eae368_render,
  kvLabeledInputvue_type_template_id_52eae368_staticRenderFns,
  false,
  null,
  null,
  null
