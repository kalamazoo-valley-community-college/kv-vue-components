...
/* harmony default export */ var kvLabeledInputvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      input: null,
      classes: ['appearance-none', 'px-3', 'pb-2', 'pt-6', 'bg-indigo-100', 'hover:bg-white', 'focus:bg-white', 'border', 'border-gray-500', 'hover:border-blue-700', 'focus:border-blue-700', 'shadow', 'rounded', 'focus:shadow-outline', 'outline-none', 'w-full'],
      styling: {
        transition: 'all 0.25s ease'
      }
    };
...
var kvLabeledInput_component = normalizeComponent(
  ...
  kvLabeledInputvue_type_template_id_0857c08a_render,
  kvLabeledInputvue_type_template_id_0857c08a_staticRenderFns,
  false,
  null,
  null,
  null
